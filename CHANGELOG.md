...
- Test
  ([`03781c1`](https://github.com/thetestlabs/commit-lint/commit/03781c1eacd12d6c46c18a1b058977c222de9b11))

- Update publish workflow triggers
  ([`75a58a2`](https://github.com/thetestlabs/commit-lint/commit/75a58a2a8930c130bb0b29f3c08d50831a0a280d))

### Code Style

- Linting and formatting rules
  ([`44ae23d`](https://github.com/thetestlabs/commit-lint/commit/44ae23dc37a0d9a4f46fcd8840e568d9db67268c))

### Continuous Integration

- Add app permissions and new token for release
  ([`1e8139a`](https://github.com/thetestlabs/commit-lint/commit/1e8139afee419ec78a71f205dfff8bde4181d67b))

- Disable pymarkdown while testing new changelog creation
  ([`a29c2dc`](https://github.com/thetestlabs/commit-lint/commit/a29c2dc8a699335985e586c6f36e518a20416778))

- Fix workflow formatting
  ([`e9c1a72`](https://github.com/thetestlabs/commit-lint/commit/e9c1a72edc2dca7967bdf2a330789ac0e1bfad91))

- Pin 3rd party actions to sha of the release
  ([`6646486`](https://github.com/thetestlabs/commit-lint/commit/664648643b2becd2af973895b469554e5c6a6867))

- Removed workflow steps
  ([`7e2d5c5`](https://github.com/thetestlabs/commit-lint/commit/7e2d5c5c9e68c3e58f86f3534a285bb4a71272b7))

- Troubleshooting
  ([`bbe6ceb`](https://github.com/thetestlabs/commit-lint/commit/bbe6ceb0853217020a002f4181237784bc7722c7))

- Troubleshooting
  ([`b883026`](https://github.com/thetestlabs/commit-lint/commit/b8830260e9fdc79a22ed8efec4871b9f5e7a1934))

- Troubleshooting
  ([`9113c97`](https://github.com/thetestlabs/commit-lint/commit/9113c97d0465bf8e7a0e7547a8672d2ef1bde8e9))

- Troubleshooting
  ([`9f5015e`](https://github.com/thetestlabs/commit-lint/commit/9f5015e34e78f80eb1d0db2c7d0ffe0188664142))

- Troubleshooting
  ([`a2d9903`](https://github.com/thetestlabs/commit-lint/commit/a2d990350dc82ecdd021ec1551673deccd096bd1))

- Troubleshooting
  ([`f60f094`](https://github.com/thetestlabs/commit-lint/commit/f60f094c097388583232bc30c060749c7e4e727c))

- Troubleshooting
  ([`f9d8c44`](https://github.com/thetestlabs/commit-lint/commit/f9d8c443f0be6554be09644b47cf1d60125da659))

- Troubleshooting
  ([`f643bb9`](https://github.com/thetestlabs/commit-lint/commit/f643bb9624e8ab55fc5a5be21b93aa196a3d0c19))

- Troubleshooting
  ([`6bce2c8`](https://github.com/thetestlabs/commit-lint/commit/6bce2c88508447ce3865c4ded5cd6b0de3f803ee))

- Troubleshooting
  ([`7d3498f`](https://github.com/thetestlabs/commit-lint/commit/7d3498f2bfee6cf7aab79633b0dbb9b629942865))

- Troubleshooting
  ([`9cf8a86`](https://github.com/thetestlabs/commit-lint/commit/9cf8a861ea4d850bda877a1d9cd8f7e7248ff5ea))

- Troubleshooting
  ([`4b98bf7`](https://github.com/thetestlabs/commit-lint/commit/4b98bf7e96d9de4cc3b2c9693cd63511c4303be7))

- Troubleshooting
  ([`72f6509`](https://github.com/thetestlabs/commit-lint/commit/72f6509d77e0482c48bc2a7741d4abfb2e7fc94a))

- Troubleshooting
  ([`255e2c2`](https://github.com/thetestlabs/commit-lint/commit/255e2c2520c2fab4011db4231c764db232a5ed39))

- Troubleshooting
  ([`164ba61`](https://github.com/thetestlabs/commit-lint/commit/164ba616f15aa3affead5ec123ef6ecf024743e8))

- Troubleshooting
  ([`1305a19`](https://github.com/thetestlabs/commit-lint/commit/1305a190bba0acf466dd3f7b9f43fe1de96d2532))

- Troubleshooting
  ([`66aeb26`](https://github.com/thetestlabs/commit-lint/commit/66aeb268a03a12c64cb985dbc5ce2104cdd9e423))

- Troubleshooting
  ([`cd984db`](https://github.com/thetestlabs/commit-lint/commit/cd984db8ed87147e7eb97892a9460dd8f7c47d42))

- Troubleshooting
  ([`6d8db02`](https://github.com/thetestlabs/commit-lint/commit/6d8db02fe28dd27e69c85fabeb9518d92b3ba28a))

- Troubleshooting
  ([`d2b0493`](https://github.com/thetestlabs/commit-lint/commit/d2b049392e48d2e2ca559f7e91da37ee1d36986d))

- Troubleshooting
  ([`b1142c8`](https://github.com/thetestlabs/commit-lint/commit/b1142c84dd42fea9c114814513991f4f09b15322))

- Troubleshooting
  ([`b76d0ab`](https://github.com/thetestlabs/commit-lint/commit/b76d0ab00a9ad43b555fd494d1936d95c383181d))

- Troubleshooting
  ([`ab5b9fa`](https://github.com/thetestlabs/commit-lint/commit/ab5b9fa9dc9e71bf5a1ad7900418d7658d39f54f))

- Troubleshooting
  ([`f51f430`](https://github.com/thetestlabs/commit-lint/commit/f51f4301e89adc09141c3571ca61c24911e486ce))

- Troubleshooting
  ([`ecd9aab`](https://github.com/thetestlabs/commit-lint/commit/ecd9aab3d157f2c4702495a81825f0d0f3ad8ab7))

- Troubleshooting
  ([`2fd3872`](https://github.com/thetestlabs/commit-lint/commit/2fd387234f0fa5b461a8d86262b0e6ba7e53e295))

- Troubleshooting
  ([`51c0748`](https://github.com/thetestlabs/commit-lint/commit/51c07482a9ff945a27856343d12c94cfb3cc3ddd))

- Troubleshooting
  ([`bbb0246`](https://github.com/thetestlabs/commit-lint/commit/bbb0246abc245eb2451e363a2ce523005c6ec707))

- Troubleshooting
  ([`90d35eb`](https://github.com/thetestlabs/commit-lint/commit/90d35eb081e60d0be51b1b79ec89c10f908ed6a1))

- Troubleshooting
  ([`07a6d1c`](https://github.com/thetestlabs/commit-lint/commit/07a6d1c4d2d1f9df45b82a03134a347ef5cbf9aa))

- Troubleshooting
  ([`db217bf`](https://github.com/thetestlabs/commit-lint/commit/db217bf9e06f4277ac6032c3281f817698a55a52))

- Troubleshooting
  ([`6bfd493`](https://github.com/thetestlabs/commit-lint/commit/6bfd493f8b894fd9bb0fab686ae581afecaaffbd))

- Troubleshooting
  ([`f4721c9`](https://github.com/thetestlabs/commit-lint/commit/f4721c9857ee58e675b1afac5fc8030e48403e3e))

- Troubleshooting
  ([`5d58ced`](https://github.com/thetestlabs/commit-lint/commit/5d58ced84a17c82d4dbcaa40fa61df5246a8c832))

- Troubleshooting
  ([`5fe98f8`](https://github.com/thetestlabs/commit-lint/commit/5fe98f804622d189e9ec89cc1ec04bd3aefd7334))

- Troubleshooting
  ([`b087357`](https://github.com/thetestlabs/commit-lint/commit/b087357b7b72478a5923dc5935ccd190520bcc18))

- Troubleshooting
  ([`9fdada3`](https://github.com/thetestlabs/commit-lint/commit/9fdada330052792c8bc6e3757a44048b018aef11))

- Update workflow files to test release-please
  ([`2cfd818`](https://github.com/thetestlabs/commit-lint/commit/2cfd8181abfb763c994373d8fadbb31a54307d4b))

- Update workflow steps
  ([`ca10cb6`](https://github.com/thetestlabs/commit-lint/commit/ca10cb6e6dc3b21ae0dac7337efd60588e5eb852))

- Update workflow steps
  ([`2a5f2cd`](https://github.com/thetestlabs/commit-lint/commit/2a5f2cd22c73d77f8dfcd839d5f7ab9f75e45391))

- Update workflow steps
  ([`d7838f3`](https://github.com/thetestlabs/commit-lint/commit/d7838f39afcc6c2de7dc6afb9e7b1e31b853786c))

- Update workflow steps
  ([`65190b3`](https://github.com/thetestlabs/commit-lint/commit/65190b3ffe30733b1bc21f5ef1361247b0a05864))
